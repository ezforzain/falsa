...
import { IconSearch, IconSliders, IconArrowRight, IconGift, IconStore, IconBox, IconSparkle, IconGrid } from '../components/icons';
import safahMartBanner from '../assets/safah-mart-banner.png';
...
export default function MobileHome() {
  ...
  return (
    <div className="min-h-screen bg-surface font-sans">
      ...
      {/* "Safah Mart" promo banner — the actual reference artwork (src/assets/safah-mart-banner.png),
