...
export const auth = {
  ...
  verifyEmailOtp: (code) => request('/api/auth/verify-email/otp', { method: 'POST', body: { code }, auth: true }),
  resendVerificationEmail: () => request('/api/auth/verify-email/resend', { method: 'POST', auth: true }),
  forgotPassword: (email) => request('/api/auth/forgot-password', { method: 'POST', body: { email } }),
  verifyResetOtp: (email, code) => request('/api/auth/forgot-password/verify', { method: 'POST', body: { email, code } }),
...
export const seller = {
  ...
  addStoreSection: (name) => request('/api/seller/store/sections', { method: 'POST', body: { name }, auth: true }),
  updateStoreSection: (sectionId, payload) =>
    request(`/api/seller/store/sections/${encodeURIComponent(sectionId)}`, { method: 'PATCH', body: payload, auth: true }),
  deleteStoreSection: (sectionId) => request(`/api/seller/store/sections/${encodeURIComponent(sectionId)}`, { method: 'DELETE', auth: true }),
  reorderStoreSections: (order) => request('/api/seller/store/sections/order', { method: 'PATCH', body: { order }, auth: true }),
