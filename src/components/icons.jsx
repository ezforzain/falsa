// Small shared SVG icon set, ported from the design exports.
...
export const IconStar = (props) => (
  <svg width="12" height="12" viewBox="0 0 24 24" fill="#C97B2D" stroke="none" {...props}>
...
export const IconSparkle = (props) => (
  <svg width="14" height="14" viewBox="0 0 24 24" fill="#C97B2D" stroke="#C97B2D" strokeWidth="1.5" strokeLinejoin="round" {...props}>
    <path d="M12 3l1.9 5.8H20l-4.9 3.6 1.9 5.8-5-3.6-5 3.6 1.9-5.8L4 8.8h6.1z" />
  </svg>
);
...
export const IconHeart = (props) => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M19 14c1.5-1.5 3-3.4 3-5.5A5.5 5.5 0 0 0 12 5a5.5 5.5 0 0 0-10 3.5C2 15 12 21 12 21s3.5-2.15 7-5.5" />
  </svg>
);
...
export const IconLanguage = (props) => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M4 5h11M9.5 3v2M4 8s1.5 4 5 6M15 8s-3 6.5-9 8" />
    <path d="M14 21l4.5-11L23 21M15.5 17.5h6" />
  </svg>
);
...
export const IconCheckCheck = (props) => (
  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
