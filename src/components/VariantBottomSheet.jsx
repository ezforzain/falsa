...
export default function VariantBottomSheet({ product, open, initialVariant = null, loading = false, error = null, onClose, onConfirm }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-end justify-center sm:items-center">
      ...
      <div className="relative w-full sm:max-w-[420px] max-h-[88vh] bg-surface rounded-t-[24px] sm:rounded-[24px] shadow-2xl flex flex-col animate-slide-up">
        {/* Header */}
        ...
        >
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 cursor-pointer disabled:cursor-not-allowed disabled:opacity-60 bg-surface border-[1.5px] border-green text-green font-bold text-[14.5px] py-[15px] rounded-full transition-all active:scale-[0.98]"
            >
