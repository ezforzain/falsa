...
router.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    const user = await User.create({
      ...
      // Buyer's optional Province/City/Village — the signup form's location step is skippable,
      // so these are simply whatever (possibly nothing) it submitted.
      locationProvince: locationProvince || null,
      locationCity: locationCity || null,
      locationVillage: locationVillage || null,
